...
namespace AgroCulture
{
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureUIByRole()
        {
            ...
            switch (role)
            {
                ...
                case "guest":
                    ...
                    ((TextBlock)((StackPanel)ListTabButton.Content).Children[1]).Text = "Каталог домиков";
                    break;
        ...
        // ═══════════════════════════════════════════════════════════
        // ✅ ПУБЛИЧНЫЙ МЕТОД ДЛЯ ОБНОВЛЕНИЯ HEADER (нужен для ProfilePage)
        // ═══════════════════════════════════════════════════════════
        ...
        private void NavigateToDefaultPage()
        {
            ...
            switch (role)
            {
                ...
                case "guest":
                    NavigateToCatalog();
                    SetActiveTab(ListTabButton); // Используем вкладку "Список"
                    break;
        ...
        {
            MainContentFrame.Content = new CabinBookingView(true);
        }
        ...
        private void ListTabButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                // Admin/Manager видят список бронирований
                NavigateToList();
            }
