...
namespace AgroCulture.Views
{
    public partial class BookingEditWindow : Window
    {
        ...
        public BookingEditWindow(int bookingId) : this()
        {
            ...
            this.Loaded += BookingEditWindow_Loaded;
        }
        ...
        private void LoadBookingData()
        {
            try
            {
                using (var context = new AgroCultureEntities())
                {
                    ...
                    // Данные домика
                    TxtCabinName.Text = $"Домик \"{bookingDetail.CabinName}\"";
                    TxtCabinPrice.Text = $"{_currentCabin.PricePerNight:N0} ₽/ночь";
                    TxtCabinCapacity.Text = $"До {_currentCabin.Capacity} чел.";
